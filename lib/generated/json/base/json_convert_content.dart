...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case BigDatasEntity:
			...
			return bigDatasDataFromJson(data as BigDatasData, json) as T;				case BigDataMenuEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case BigDatasEntity:
			...
			return bigDatasDataToJson(data as BigDatasData);				case BigDataMenuEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'BigDatasEntity':
			...
			return BigDatasData().fromJson(json);			case 'BigDataMenuEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'BigDatasEntity':
			...
			return List<BigDatasData>();
					case 'BigDataMenuEntity':
